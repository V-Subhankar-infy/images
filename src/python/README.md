...
| *Available image variants* | 3 / 3-trixie, 3.9 / 3.9-trixie, 3.10 / 3.10-trixie, 3.11-trixie / 3.11, 3.12-trixie / 3.12, 3.13-trixie / 3.13,  3.14-trixie / 3.14, 3-bookworm, 3.11-bookworm, 3.12-bookworm, 3.13-bookworm, 3.14-bookworm ([full list](https://mcr.microsoft.com/v2/devcontainers/python/tags/list)) |
...
- `mcr.microsoft.com/devcontainers/python:3.10` (or `3.10-trixie` to pin to an OS version)
...
- `mcr.microsoft.com/devcontainers/python:3.1.2-3.13` (or `3.1.2-3.13-trixie`)
